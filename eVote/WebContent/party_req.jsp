...
<nav id="menu" style="background:url(image/navBg.png repeat-x;)">
    	<ul id="submenu">
            ...
            <li><a href="party_req.jsp" style="background-color:orange;" >Party Req</a></li>
    ...
    <section id="sec">
    	<div id="cont">
    	<%
    	ResultSet rs =ob.viewparty();
    	%>
    	<table class="tab" bprder="1">
    	<caption>Party Request</caption>
    	<tr>
    	<th>Name</th>
    	<th>Leader </th>
    	<th>EmailId</th>
    	...
    	<td><a href=add.jsp?name=<%= rs.getString("NAME") %>>Accept</a></td>
    	<td><a href=reject.jsp?name=<%= rs.getString("NAME") %>>Reject</a></td>
    	</tr>
    	<%} %>
