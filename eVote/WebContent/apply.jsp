...
<nav id="menu" style="background:url(image/navBg.png repeat-x;)">
    ...
    <section id="sec">
    	<div id="cont">
					<center>
					<table border="1" hight="90"><tr><td width="850">
					<form action="reg.jsp?choice=6" method="post">
					 <p>
					 Date of Birth proof:<br>
					<label for="text">Document Name:</label>
					<input type="text" name="dobd" id="dobd"><br>
					<label for="text">Upload File:</label>
					<input type="file" name ="udobd"> 
					</p> 
					<p>   
					Address Proof:<br>
					<label for="add">Document Name:</label>
					<input type="text" name="adpd" id="adpd"><br>
					<label for="add">Upload File:</label>
					<input type="file" name="uadpd">
					</p>
					<input type="submit">
					</form>
</td></tr></table></center>
